...
main-notice =
    Welcome to the alpha version of Coping chronicles!
    ...
    - Coping chronicles is open source. You are free to play, modify, and redistribute the game in accordance to version 3 of the GNU General Public license.

    - Coping chronicles is a non-profit community project, and everybody working on it is a volunteer.
...
loading-tips =
    ...
    .a14 = Coping chronicles is still in Pre-Alpha. We do our best to improve it every day!
