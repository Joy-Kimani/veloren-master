...
main-notice =
    Bienvenue dans la version alpha de Coping chronicles !
    ...
    - Coping chronicles est un jeu open source. Vous êtes libre de jouer, de modifier et de redistribuer le jeu conformément à la version 3 de la licence publique générale GNU.

    - Coping chronicles est un projet communautaire à but non-lucratif développé par des bénévoles.
...
loading-tips =
    ...
    .a14 = Coping chronicles est encore en Pré-Alpha. Nous faisons de notre mieux pour l'améliorer chaque jour !
