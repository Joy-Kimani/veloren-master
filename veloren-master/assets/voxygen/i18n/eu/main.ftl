...
main-notice =
    Ongi etorri Coping chroniclesen alpha bertsiora!
    ...
    - Coping chronicles GPL-3 lizentzia librean banatzen da. Horrek esan nahi du libre zarela jokatu, aldatu eta nahi bezala banatzeko (betiere GPL-3 lizentziaren baldintzak betetzen badituzu)

    - Coping chronicles irabazi asmorik gabeko proiektua da, eta guztiok bertan modu boluntarioan egiten dugu lan.
    ...
    ~ Coping chroniclesen garatzaile taldea
main-login_process =
...
loading-tips =
    ...
    .a14 = Coping chronicles oraindik Pre-Alpha bertsioan dago. Ahalegin handia egiten dugu egunero hobetzeko!
