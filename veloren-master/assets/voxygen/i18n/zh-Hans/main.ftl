...
main-notice =
    欢迎加入 Coping chronicles Alpha 版本!
    ...
    - Coping chronicles 的授权条款是GPL3. 意思是你可以免费游玩,
    修改并重新发布游戏(衍生内容也必须是GPL3)

    - Coping chronicles 是一个非营利的社区项目, 参与该项目的都是志愿者.
...
loading-tips =
    ...
    .a14 = Coping chronicles 处于Pre-Alpha阶段. 我们每天都在努力改善它!
