...
main-notice =
    Wilkommen in der Alpha-Version von Coping chronicles!
    ...
    - Coping chronicles ist Open Source. Du hast die Freiheit, das Spiel unter den Bedingungen der GPL-3-Lizenz zu spielen, zu verändern und weiterzuverbreiten.

    - Coping chronicles ist ein Non-Profit Community Projekt und jeder Mitarbeiter entwickelt es als Hobby in seiner Freizeit.
...
loading-tips =
    ...
    .a14 = Coping chronicles ist immernoch in der Pre-Alpha. Wir tun unser Bestes, um es jeden Tag ein Stück besser zu machen!
