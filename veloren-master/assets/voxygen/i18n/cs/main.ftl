...
main-tip = Tip:
main-notice =
    Vítejte v alfa verzi Coping chroniclesu!
    ...
    - Coping chronicles je s otevřeným zdrojem. Můžete hrát, modifikovat a sdílet hru v souladu s Obecnou veřejnou licencí GNU v.3.

    - Coping chronicles je neziskový projekt, kde je každý spolupracující člověk dobrovolníkem.Pokud se vám tato hra líbí, připojte se k našemu týmu!

    Děkujeme za přečtení této zprávy a doufáme, že se vám tato hra bude líbit!

    ~ Tvůrci Coping chronicles
main-login_process =
    O režimu více hráčů:
...
loading-tips =
    ...
    .a14 = Coping chronicles je stále v Pre-Alpha. Snažíme se hru zlepšit co to jde!
