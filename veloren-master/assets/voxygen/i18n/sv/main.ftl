...
main-notice =
    Välkommen till alfa-versionen av Coping chronicles!
    ...
    - Coping chronicles är öppen källkod. Du får spela, modifiera, och sprida spelet vidare som du vill i enlighet med version 3 av GNU General Public License.

    - Coping chronicles är ett ideellt community-projekt, och alla som jobbar på det är en volontär.
...
loading-tips =
    ...
    .a14 = Coping chronicles är fortfarande i Pre-Alpha. Vi gör vårt bästa för att förbättra det varje dag!
