...
main-notice =
    Witaj w wersji alfa Coping chronicles!
    ...
    - Coping chronicles jest objęte licencją typu open-source 'GNU GPLv3'.
    ...
    - Coping chronicles jest projektem non-profit, w całości tworzonym przez wolontariuszy w wolnym czasie.
    Jeśli polubisz Coping chronicles, zapraszamy cię do dołączenia do naszego zespołu! Nowi programiści, artyści, tłumacze i inni są zawsze mile widziani!

    Dziękujemy za przeczytanie tej notki i życzymy miłej gry!

    ~ Zespół Twórców Coping chronicles
main-login_process =
...
loading-tips =
    ...
    .a14 = Coping chronicles dalej jest w fazie Pre-Alpha. Staramy się ulepszać go dzień w dzień!
