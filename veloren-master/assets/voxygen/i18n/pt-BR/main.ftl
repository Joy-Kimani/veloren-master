...
main-notice =
    Bem-vindo a versão alfa de Coping chronicles!
    ...
    - Coping chronicles é open source. Você é livre pra jogar, modificar e redistribuir desde que em acordo com a versão 3 da GNU General Public license.

    - Coping chronicles é um projeto comunitário sem fins lucrativos, e todos que trabalham nele são voluntários.
...
loading-tips =
    ...
    .a14 = Coping chronicles ainda está no Pre-Alpha. Estamos nos empenhando ao máximo para melhorar a cada dia!
