...
main-notice =
    Вітаємо в альфа-версії Coping chronicles!
    ...
    - Coping chronicles - це проект з відкритим кодом. Ви можете вільно грати, змінювати та поширювати гру відповідно до версії 3 загальнодоступної ліцензії GNU.

    - Coping chronicles - це неприбутковий проект, і всі, хто над ним працюють - волонтери.
...
loading-tips =
    ...
    .a14 = Coping chronicles все ще на стадії ранньої альфи. Ми стараємося кожного дня щоб робити покращення!
