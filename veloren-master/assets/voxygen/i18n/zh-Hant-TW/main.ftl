...
main-notice =
    歡迎來到 Coping chronicles 的 Alpha 版本！
    ...
    - Coping chronicles 是開源的，根據 GNU 通用公共授權條款第 3 版，您可以自由玩、修改和重新發佈遊戲

    - Coping chronicles 是非營利的社群項目，所有貢獻者都是志願者
...
loading-tips =
    ...
    .a14 = Coping chronicles 還在 Pre-Alpha 階段，我們每天都在努力改進它！
