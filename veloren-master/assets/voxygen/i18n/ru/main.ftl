...
main-notice =
    Добро пожаловать в альфа-версию Coping chronicles!
    ...
    - Coping chronicles - это проект с открытым исходным кодом. Это означает, что вы можете изменять и распространять игру в рамках лицензии GPL 3.

    - Coping chronicles - это некоммерческий общественный проект, и все, кто работает над ним, являются добровольцами.
    ...
    ~ Разработчики Coping chronicles
main-login_process =
    Информация касаемо многопользовательского режима:

    Имейте ввиду то, что вам необходимо иметь аккаунт Coping chronicles чтобы играть на серверах с включенной аутентификацией
...
loading-tips =
    ...
    .a14 = Coping chronicles все еще находится в Пре-Альфе. Мы делаем всё возможное, чтобы улучшать его каждый день!
