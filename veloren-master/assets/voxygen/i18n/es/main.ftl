...
main-notice =
    ¡Bienvenido a la versión alfa de Coping chronicles!
    ...
    - Coping chronicles es un juego de código abierto. Esto quiere decir que eres libre de jugar, modificar y redistribuir el juego en acuerdo con los términos y condiciones de la versión 3 de la licencia "GNU General Public License".

    - Coping chronicles es un proyecto comunitario sin ánimo de lucro, y todo aquel que trabaja en él es un voluntario.
...
loading-tips =
    ...
    .a14 = Coping chronicles se encuentra todavia en pre-alfa. ¡Hacemos todo lo posible para mejorar la experiencia de juego día a día!
