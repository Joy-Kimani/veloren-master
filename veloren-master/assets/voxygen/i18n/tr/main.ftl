...
main-tip = İpucu:
main-notice =
    Coping chronicles Alfa sürümüne hoşgeldin!
    ...
    - Coping chronicles GPL 3 açık kaynak lisansı ile lisanslıdır. Bunun anlamı, oyunu istediğin gibi oynayabilir, değiştirebilir ve dağıtabilirsin
    (türetilmiş çalışmalarda GPL 3 ile lisanslanmış olduğu sürece)

    - Coping chronicles kar gütmeyen bir topluluk projesidir ve üzerinde çalışan herkes birer gönüllüdür.
    ...
    ~ Coping chronicles Geliştiricileri
main-login_process =
    ...
    https://coping chronicles.net/account/ adresinden
...
loading-tips =
    ...
    .a14 = Coping chronicles hala Pre-Alpha'da. Onu geliştirmek için her gün elimizden geleni yapıyoruz!
