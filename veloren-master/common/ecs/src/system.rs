...
/// This trait wraps around specs::System and does additional coping chronicles tasks like
/// metrics collection
///
/// ```
/// use specs::Read;
/// pub use COPING CHRONICLES_common_ecs::{Job, Origin, ParMode, Phase, System};
