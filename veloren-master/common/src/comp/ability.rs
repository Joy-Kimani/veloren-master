...
impl Stance {
    pub fn pseudo_ability_id(&self) -> &str {
        match self {
            Stance::Sword(SwordStance::Heavy) => "coping chronicles.core.pseudo_abilities.sword.heavy_stance",
            Stance::Sword(SwordStance::Agile) => "coping chronicles.core.pseudo_abilities.sword.agile_stance",
            Stance::Sword(SwordStance::Defensive) => {
                "coping chronicles.core.pseudo_abilities.sword.defensive_stance"
            },
            Stance::Sword(SwordStance::Crippling) => {
                "coping chronicles.core.pseudo_abilities.sword.crippling_stance"
            },
            Stance::Sword(SwordStance::Cleaving) => {
                "coping chronicles.core.pseudo_abilities.sword.cleaving_stance"
            },
            Stance::None => "coping chronicles.core.pseudo_abilities.no_stance",
        }
    }
}
