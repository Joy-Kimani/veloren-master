...
///
/// ```
/// COPING CHRONICLES_common::make_case_elim!(
///     my_type_module,
///     #[repr(u32)]
///     #[derive(Clone,Copy)]
///     pub enum MyType {
...
///     impl<T> PackedElim for COPING CHRONICLES_common::typed::Pure<T> {
///         type Constr1 = T;
///         type Constr2 = T;
///     }
///
...
///     pub type PureCases<Elim> = Cases<COPING CHRONICLES_common::typed::Pure<Elim>>;
/// }
/// ```
///
