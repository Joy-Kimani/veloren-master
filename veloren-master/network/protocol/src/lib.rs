//! Network Protocol
//!
//! a I/O-Free protocol for the coping chronicles network crate.
...
pub use types::{Bandwidth, Cid, HIGHEST_PRIO, Pid, Prio, Promises, Sid, COPING CHRONICLES_NETWORK_VERSION};
