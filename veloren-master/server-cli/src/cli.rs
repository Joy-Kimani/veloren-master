...
#[derive(Parser)]
#[command(
    name = "Coping chronicles server TUI",
    version = common::util::DISPLAY_VERSION_LONG.as_str(),
    about = "The coping chronicles server tui allows sending commands directly to the running server.",
    author = "The coping chronicles devs <https://gitlab.com/coping chronicles/coping chronicles>",
)]
...
#[command(
    ...
    version = common::util::DISPLAY_VERSION_LONG.as_str(),
    about = "The coping chronicles server cli provides an easy to use interface to start a coping chronicles server.",
    author = "The coping chronicles devs <https://gitlab.com/coping chronicles/coping chronicles>",
)]
pub struct ArgvApp {
    #[arg(long, short)]
