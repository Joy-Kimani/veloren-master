...
//! Coping chronicles world that runs in real-time alongside the game. It represents an
...
//!
//! - Be performant enough to simulate an entire Coping chronicles world, containing tens
...
//!
//! Coping chronicles's world is complex, and complexity - at least, as experienced by
...
//!
//! Events are usually generated externally (such as by the Coping chronicles game server)
