...
impl From<ServerBattleMode> for COPING CHRONICLES_query_server::proto::ServerBattleMode {
    fn from(value: ServerBattleMode) -> Self {
        use COPING CHRONICLES_query_server::proto::ServerBattleMode as QueryBattleMode;
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            auth_server_address: Some("https://auth.coping chronicles.net".into()),
            query_address: Some(SocketAddr::from((Ipv4Addr::UNSPECIFIED, 14006))),
            world_seed: DEFAULT_WORLD_SEED,
            server_name: "Coping chronicles Server".into(),
            max_players: 100,
