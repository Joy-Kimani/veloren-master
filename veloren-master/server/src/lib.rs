...
use vek::*;
use COPING CHRONICLES_query_server::server::QueryServer;
...
impl Server {
    ...
    pub fn new(
        ...
        if let Some(addr) = settings.query_address {
            use COPING CHRONICLES_query_server::proto::ServerInfo;
            ...
            let query_server_metrics =
                Arc::new(Mutex::new(COPING CHRONICLES_query_server::server::Metrics::default()));
        ...
        debug!(?settings, "created coping chronicles server with");
    ...
    pub fn tick(&mut self, _input: Input, dt: Duration) -> Result<Vec<Event>, Error> {
        ...
        *self.state.ecs_mut().write_resource::<Calendar>() = new_calendar;
        ...
        // This tick function is the centre of the Coping chronicles universe. Most server-side
        ...
        //   https://gitlab.com/coping chronicles/coping chronicles/-/merge_requests/2668#note_634913847
