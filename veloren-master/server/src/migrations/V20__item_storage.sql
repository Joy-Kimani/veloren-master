...
SELECT  item_id
FROM    item
WHERE   item_definition_id = 'coping chronicles.core.pseudo_containers.loadout';
...
WITH inventory_items AS (
    ...
    WHERE   i.item_definition_id = 'coping chronicles.core.pseudo_containers.inventory'
),
     new_positions AS (
         SELECT item_id,
