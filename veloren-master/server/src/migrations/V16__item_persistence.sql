...
VALUES  (1,
         1,
         'coping chronicles.core.pseudo_containers.world',
         1,
         'world');
...
SELECT  c.id + 1,
        ...
        'coping chronicles.core.pseudo_containers.character',
        1,
        c.id + 1  -- Position
...
SELECT  c.id + 1 + (1 * (SELECT MAX(cb.id) + 1 FROM _character_bak cb)),
        ...
        'coping chronicles.core.pseudo_containers.inventory',
        1,
        'inventory' -- Position
FROM    _character_bak c;
...
SELECT  c.id + 1 + (2 * (SELECT MAX(cb.id) + 1 FROM _character_bak cb)),
        ...
        'coping chronicles.core.pseudo_containers.loadout',
        1,
        'loadout' --Position
FROM    _character_bak c;
