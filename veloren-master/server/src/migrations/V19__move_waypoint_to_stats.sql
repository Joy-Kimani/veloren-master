...
SET     waypoint =  (   SELECT    i.position
                        ...
                        AND       i.item_definition_id = 'coping chronicles.core.pseudo_containers.character')
...
WHERE   item_definition_id = 'coping chronicles.core.pseudo_containers.character';