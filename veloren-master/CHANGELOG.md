...
- Type /wiki to open or the Coping chronicles wiki or /wiki [topic] to search for a specific topic.
...
- Add COPING CHRONICLES_ASSETS_OVERRIDE variable for specifying folder to partially override assets.
- Cultist raiders.
- Bloom Slider.
...
- Added `--sql-log-mode` profile/trace parameter to coping chronicles-server-cli.
...
- Added authentication system (to play on the official server register on <https://account.coping chronicles.net>).
