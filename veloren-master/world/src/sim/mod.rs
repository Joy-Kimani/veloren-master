    ...
    fn try_load_map(&self) -> Option<ModernMap> {
        let map = match self {
            ...
            Self::LoadOrGenerate {
                ...
                let map = match map {
                    WorldFile::Coping chronicles0_7_0(map) => map,
                    WorldFile::Coping chronicles0_5_0(_) => {
...
/// Version of the world map intended for use in Coping chronicles 0.5.0.
#[derive(Serialize, Deserialize)]
#[repr(C)]
...
/// Version of the world map intended for use in Coping chronicles 0.7.0.
#[derive(Serialize, Deserialize)]
#[repr(C)]
...
///
/// The map is versioned to enable format detection between versions of Coping chronicles,
...
#[repr(u32)]
pub enum WorldFile {
    Coping chronicles0_5_0(WorldMap_0_5_0) = 0,
    Coping chronicles0_7_0(WorldMap_0_7_0) = 1,
}
...
pub const DEFAULT_WORLD_MAP: &str = "world.map.COPING CHRONICLES_0_18_0_0";
...
impl WorldFile {
    ...
    /// version.
    pub fn new(map: ModernMap) -> Self { WorldFile::Coping chronicles0_7_0(map) }
    ...
    pub fn into_modern(self) -> Result<ModernMap, WorldFileError> {
        match self {
            WorldFile::Coping chronicles0_5_0(map) => map.into_modern(),
            WorldFile::Coping chronicles0_7_0(map) => map.into_modern(),
        }
    }
}
