...
impl Default for NetworkingSettings {
    fn default() -> Self {
        Self {
            username: "".to_string(),
            servers: vec!["server.coping chronicles.net".to_string()],
            default_server: "server.coping chronicles.net".to_string(),
            trusted_auth_servers: ["https://auth.coping chronicles.net"]
                .iter()
                .map(|s| s.to_string())
                .collect(),
            use_srv: true,
