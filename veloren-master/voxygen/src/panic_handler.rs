...
pub fn set_panic_hook(log_filename: String, logs_dir: PathBuf) {
    ...
    panic::set_hook(Box::new(move |panic_info| {
        ...
        if let Some(potential_cause) = potential_cause {
            ...
            reporting this problem. To do this, open an issue on the Coping chronicles \
            issue tracker:\n\
            \n\
            https://www.gitlab.com/coping chronicles/coping chronicles/issues/new\n\
            \n\
            If you're on the Coping chronicles community Discord server, we'd be \
        ...
        #[cfg(feature = "native-dialog")]
        {
            ...
            let mbox = move || {
                MessageDialog::new()
                    .set_title("Coping chronicles has crashed!")
